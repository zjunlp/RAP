...
class LabelConstraint:
    def __init__(
        ...
        label_map = json.load(open("./outputs/data/relations/" + base_data + "_relations_dict.json", "r"))
        ...
        self.label_map: Dict[int, str] = {
            ...
            # tokenizer(x, add_special_tokens=True).input_ids[1]: x for x in labels
        }
        assert (len(self.label_map) == len(labels))
        print("len_label_map:", len(self.label_map))
