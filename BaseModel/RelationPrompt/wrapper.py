...
class Extractor(BaseModel):
    ...
    def predict_multi(self, path_in: str, path_out: str, base_data: str):
        ...
        assert isinstance(model, NewRelationExtractor)
        gen = model.load_generator(torch.device("cuda"))
        constraint = LabelConstraint(labels=data.get_labels(), tokenizer=gen.tokenizer, base_data=base_data)
