...
class BertForRE(BertPreTrainedModel):
    ...
    def forward(
        ...
        # print("attention_mask_before:",attention_mask)
        outputs = self.bert(
            input_ids,
        ...
        if origin_attention_mask != None:
            attention_mask = origin_attention_mask
        # print("attention_mask_after:",attention_mask)
        # print("input_ids:",input_ids)
        # print("sequence_output:",sequence_output.shape)
        # print("sequence_output_0_shape:",sequence_output[0].shape)
        # print("sequence_output_0:",sequence_output[0])
        # print("attention_mask:",attention_mask.shape)
        bs, seq_len, h = sequence_output.size()
        # print("seq_tags:",seq_tags)
        ...
        if ensure_corres:
            ...
            # print("corres_mask.shape:", corres_mask.shape)
            # print("corres_mask:", corres_mask)
        ...
        if ensure_rel and seq_tags is None:
            ...
            # print("rel_pred_onehot:", rel_pred_onehot)
