...
class CustomDataLoader(object):
    ...
    def collate_fn_train(features):
        ...
        origin_attention_mask = torch.tensor([f.origin_attention_mask for f in features], dtype=torch.long) 
        tensors = [input_ids, attention_mask, seq_tags, poten_relations, corres_tags, rel_tags, origin_attention_mask]
        return tensors
    ...
    def collate_fn_test(features):
        ...
        origin_attention_mask = torch.tensor([f.origin_attention_mask for f in features], dtype=torch.long)
        tensors = [input_ids, attention_mask, triples, input_tokens, origin_attention_mask]
        return tensors
