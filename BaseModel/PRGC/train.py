...
def train(model, data_iterator, optimizer, params, ex_params):
    ...
    for step, _ in enumerate(t):
        ...
        input_ids, attention_mask, seq_tags, relations, corres_tags, rel_tags, origin_attention_mask = batch
        ...
        loss, loss_seq, loss_mat, loss_rel = model(input_ids, attention_mask=attention_mask, seq_tags=seq_tags,
                                                   ...
                                                   ex_params=ex_params, origin_attention_mask=origin_attention_mask)
...
def train_and_evaluate(model, params, ex_params, restore_file=None):
    ...
    for epoch in range(1, args.epoch_num + 1):
        ...
        if epoch < args.epoch_num/2 : continue
...
if __name__ == '__main__':
    ...
    print("ex_index:", args.ex_index)
    print("corpus_type:", args.corpus_type)
